...
X_train_v1, X_test_v1, y_train_v1, y_train_v1 = (
    limpar_separar_e_dividir_dados(dados_exemplo, coluna_alvo="comprou")
)
...
X_train_v2, X_test_v2, y_train_v2, y_test_v2 =  dividir_em_treino_e_teste(
    X, y
) 
