...
class ContaPoupanca(ContaBancaria):
    ...
    def calcular_juros(self):
        ...
        self._saldo += juros
        print(f"Juros de R$ {juros} aplicados. Novo saldo: R$ {self._saldo:.2f}")
...
class ContaCorrente(ContaBancaria):
    ...
    def saque(self, valor_desejado):
        if self._saldo >= valor_desejado:
            ...
            print(f"Saque de R$ {valor_desejado} realizado com sucesso utilizando o cheque especial.")
    ...
    def deposito(self, valor_depositado):
        if valor_depositado > 0:
            ...
            if limite_utilizado > 0:
                ...
                print(f"R$ {valor_a_repor} utilizado para restaurar o limite do cheque especial.")

                if valor_restante > 0:
                    self._saldo += valor_restante
                    print(f"Depósito de R$ {valor_restante} realizado com sucesso.")
            else:
                self._saldo += valor_depositado
                print(f"Depósito de R$ {valor_depositado} realizado com sucesso.")
        else:
    ...
    def consultar_saldo(self):
        ...
        print(f"Saldo atual: R$ {self._saldo}")
        print(f"Limite disponível do cheque especial: R$ {self._limite_disponivel}")
