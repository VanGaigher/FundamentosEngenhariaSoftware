        ...
        if valor_depositado > 0:
            ...
            if limite_utilizado > 0:
                ...
                if valor_restante > 0:
                    ...
                    print(
                        f"Depósito de R$ {valor_restante} realizado com sucesso na conta corrente."
                    )
            else:
                self._saldo += valor_depositado
                print(
                    f"Depósito de R$ {valor_depositado} realizado com sucesso na conta corrente."
                )
        else:
            print("Valor de depósito inválido.")
...
if __name__ == "__main__":
    cb = ContaCorrente(1, "vanessa", 1000, 500)
    cb.consultar_saldo()
    cb.saque(1200)
    cb.deposito(2000)
