...
def test_document_feature_creator_transform(document_dataframe):
    ...
    # "entrega_doc_2": [1, 0, np.nan, 1, 0, np.nan, 1],
    # "entrega_doc_3": [0, 1, 1, 0, 0, 0, 1],
    expected_values_entrega_doc_2_nan = [0, 0, 1, 0, 0, 1, 0]
    expected_values_entrega_doc = [1, 1, 1, 1, 0, 1, 1]

    assert np.array_equal(
        result["entrega_doc_2_nan"], expected_values_entrega_doc_2_nan
    )
    assert np.array_equal(result["entrega_doc"], expected_values_entrega_doc)
