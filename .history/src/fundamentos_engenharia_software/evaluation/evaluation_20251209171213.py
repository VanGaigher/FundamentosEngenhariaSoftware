...
class ModelEvaluator:
    ...
    def __init__(
        ...
        self.y_train_proba: pd.Series = None
        self.y_pred_proba: pd.Series = None
        self.y_pred: pd.Series = None
    ...
    def load_data_and_artifacts(self) -> None:
        ...
        try:
            ...
            self.model_path = joblib.load(self.model_path)
            self.x_train_path = pd.read_csv(self.x_train_path)
            self.y_train_path = pd.read_csv(self.y_train_path).squeeze()
            self.x_test_path = pd.read_csv(self.x_test_path)
            self.y_test_path = pd.read_csv(self.y_test_path).squeeze()
    ...
    def calculate_metrics(self) -> None:
        ...
        # Métricas
        train_auc = roc_auc_score(self.y_train, self.y_train_proba)
