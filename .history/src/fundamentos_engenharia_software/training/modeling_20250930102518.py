...
def select_features_important(X_train, X_test):
    ...
    """
    top_features = ['entrega_doc_2_nan', 'score_10', 'grupo_categorias', 'entrega_doc_1', 'score_6', 'score_9', 'score_1', 'score_7', 'valor_compra', 'score_4', 'score_2', 'entrega_doc_3', 'score_3']
